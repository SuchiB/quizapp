...
class ChoicesControllerTest < ActionController::TestCase
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post :create, choice: { correct: @choice.correct, question_id: @choice.question_id, questiontype_id: @choice.questiontype_id, text: @choice.text }
    end
  ...
  test "should update choice" do
    patch :update, id: @choice, choice: { correct: @choice.correct, question_id: @choice.question_id, questiontype_id: @choice.questiontype_id, text: @choice.text }
    assert_redirected_to choice_path(assigns(:choice))
  end
